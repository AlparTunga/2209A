...
public class BoxCollisionImguı : MonoBehaviour
{
    ...
    void OnLayout()
    {
        ...
        if (showIntro)
        {
            ...
            ImGui.Begin("Carpisma - Giris", flags);
            ImGui.TextWrapped("Bu simülasyonda kutuların çarpışma çeşitleri incelenir.");
            ImGui.TextWrapped("Momentum, enerji ve itme değerleri hesaplanır.");
        ...
        if (ImGui.RadioButton("Asiri Surtunmeli",  selectedFloor == FloorType.Rough)) SetFloor(FloorType.Rough);
        ...
        if (showGuideWindow)
        {
            ...
            ImGui.TextWrapped("Nasil kullanilir?");
            ...
            ImGui.BulletText("Son Carpisma: Itme ve son hizlar gosterilir.");
            ImGui.End();
        }
    }
